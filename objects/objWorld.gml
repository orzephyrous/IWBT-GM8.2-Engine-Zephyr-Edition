...
if (keyboard_check_pressed(vk_escape) || (keyboard_check_direct(vk_alt) && keyboard_check_pressed(vk_f4)))
{
...
if (keyboard_check_pressed(vk_f4) && !global.gamePaused && !keyboard_check_direct(vk_alt))    //toggle fullscreen mode
{
